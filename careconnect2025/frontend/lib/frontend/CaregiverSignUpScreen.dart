    ...
    if (_currentStep < 3) {
      ...
      if (_formKey.currentState!.validate()) {
        ...
        try {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Registration failed: ${error.toString().replaceFirst("Exception: ", "")}')),
          );
        }
      }
    }
          ...
          child: Stepper(
            ...
            steps: [
              ...
              Step(
                ...
                content: Column(
                  children: [
                    TextFormField(controller: _address1Controller, decoration: const InputDecoration(labelText: 'Address line 1')),
                    TextFormField(controller: _address2Controller, decoration: const InputDecoration(labelText: 'Address line 2 (optional)')),
              ...
              Step(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    const Text("Standard Plan - \$20/patient/month\nBilled monthly. Cancel anytime."),
                    const SizedBox(height: 8),
                    const Text("2. Payment Details:"),
                    TextFormField(controller: _cardNumberController, decoration: const InputDecoration(labelText: 'Card Number')),
                    Row(
                      children: [
                        Expanded(child: TextFormField(controller: _expiryController, decoration: const InputDecoration(labelText: 'MM/YY'))),
                        const SizedBox(width: 10),
                        Expanded(child: TextFormField(controller: _cvcController, decoration: const InputDecoration(labelText: 'CVC'))),
                      ],
                    ),
                    const SizedBox(height: 8),
                    const Text("3. Billing Address:"),
                    TextFormField(controller: _billingAddress1Controller, decoration: const InputDecoration(labelText: 'Address line 1')),
                    TextFormField(controller: _billingAddress2Controller, decoration: const InputDecoration(labelText: 'Address line 2 (optional)')),
                    TextFormField(controller: _billingStateController, decoration: const InputDecoration(labelText: 'State')),
                    TextFormField(controller: _billingZipController, decoration: const InputDecoration(labelText: 'ZIP Code')),
                  ],
                ),
              ),
              Step(
                ...
                content: Column(
                  children: [
                    ...
                    TextFormField(controller: _confirmPasswordController, obscureText: true, decoration: const InputDecoration(labelText: 'Retype Password')),
                    Row(
                      children: [
                        Checkbox(value: true, onChanged: (val) {}),
                        const Expanded(
                          child: Text("I understand and agree to our Terms & Conditions and Privacy Policy."),
                        ),
                      ],
                    )
                  ],
