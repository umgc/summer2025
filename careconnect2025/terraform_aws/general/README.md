...
1. **Get a variable file ready to run the commands. This is needed to prevent data breach. Your variable file can look like below file [general.tfvars](#variable-file-sample)**
